...
using PlatformerGame.Model;
using PlatformerGame.View;
...
namespace PlatformerGame.Model
{
	...
	class Time
	{
		...
		/// </summary>
		public Time(Level level, Vector2 position)
		{
			this.level = level;
		...
		{
			spriteBatch.Draw(texture, Position, null, getRandomColor(), 0.0f, origin, 1.0f, SpriteEffects.None, 0.0f);
		}
